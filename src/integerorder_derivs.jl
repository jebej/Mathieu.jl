function cep_prime(n::Order,q::Number,z,N::Integer=matsize3(n,q))
...
function cea_prime(n::Order,q::Number,z,N::Integer=matsize3(n,q))
...
function sea_prime(n::Order,q::Number,z,N::Integer=matsize3(n,q))
...
function sep_prime(n::Order,q::Number,z,N::Integer=matsize3(n,q))
